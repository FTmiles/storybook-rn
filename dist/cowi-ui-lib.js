...
import React__default, { useLayoutEffect, useEffect, useState, forwardRef, createElement } from "react";
...
const SVGIcon = ({
  ...
  return /* @__PURE__ */ jsx("span", { dangerouslySetInnerHTML: { __html: coloredSvg } });
};
const ChevronIcon = ({ isOpen }) => {
  return /* @__PURE__ */ jsx("div", { className: "relative w-3 h-3", children: isOpen ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-3 h-3 text-gray-400" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-3 h-3 text-gray-400" }) });
};
const ApplicationsDropdown = ({
  ...
  if (applications.length === 0) {
    return /* @__PURE__ */ jsx("div", { className: "flex items-center text-sm bg-white border border-gray-200 w-full gap-2 p-3", children: /* @__PURE__ */ jsx("span", { className: "text-sm", children: "No applications available" }) });
  }
  return /* @__PURE__ */ jsxs(DropdownMenu, { onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsxs(DropdownMenuTrigger, { className: "flex items-center bg-white border border-gray-200 w-full gap-2 p-3 focus:bg-gray focus:outline-none", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        normalizedApps[selectedIndex].icon && /* @__PURE__ */ jsx(
          SVGIcon,
          {
        ...
        /* @__PURE__ */ jsx("span", { className: "text-sm", children: normalizedApps[selectedIndex].applicationName })
      ] }),
    ...
    /* @__PURE__ */ jsx(
      DropdownMenuContent,
      {
        ...
        children: normalizedApps.map((app, index2) => /* @__PURE__ */ jsx(
          DropdownMenuItem,
          {
            className: cn(
            ...
            children: /* @__PURE__ */ jsxs(
              "a",
              {
                ...
                children: [
                  app.icon && /* @__PURE__ */ jsx(SVGIcon, { svgString: app.icon, color: app.iconColor }),
                  " ",
                  /* @__PURE__ */ jsx("span", { className: "text-sm", children: app.applicationName })
                ]
              }
            )
          },
...
const HelpSupportLink = () => /* @__PURE__ */ jsx("div", { className: "bg-white", children: /* @__PURE__ */ jsxs(
  "a",
  {
    href: "/help-support",
    className: cn(
    ...
    children: [
      /* @__PURE__ */ jsx(CircleHelp, { size: 18 }),
      /* @__PURE__ */ jsx("span", { children: "Help & Support" })
    ]
  }
) });
const ApplicationSpecificMenu = React__default.forwardRef(({ applicationMenuItems: menuItems }, ref) => {
  return /* @__PURE__ */ jsxs("div", { ref, className: "flex flex-col w-64 h-full bg-white", children: [
    /* @__PURE__ */ jsx("div", { className: "flex-none", children: (menuItems == null ? void 0 : menuItems.length) ? menuItems.map((item) => /* @__PURE__ */ jsxs(
      "a",
      {
        href: item.link,
        className: cn(
      ...
      item.link
    )) : /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 p-3 text-gray-400", children: /* @__PURE__ */ jsx("span", { className: "text-sm", children: "No menu items available" }) }) }),
    /* @__PURE__ */ jsx("div", { className: "flex-1" }),
    /* @__PURE__ */ jsx("div", { className: "flex-none", children: /* @__PURE__ */ jsx(HelpSupportLink, {}) })
  ] });
});
...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(DialogPortal, { children: [
  ...
  /* @__PURE__ */ jsxs(
    Content,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsxs(Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-gray-900", children: [
...
const Checkbox = React.forwardRef(({ className, label, labelClassName, id: propId, ...props }, ref) => {
...
const SelectTrigger = React__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
  Trigger,
  {
    ref,
    className: cn(
...
const SelectScrollUpButton = React__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ScrollUpButton,
  {
    ref,
    className: cn(
...
const SelectScrollDownButton = React__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ScrollDownButton,
  {
    ref,
    className: cn(
...
const SelectContent = React__default.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ jsx(Portal, { children: /* @__PURE__ */ jsxs(
  Content2,
  {
    ref,
    className: cn(
...
const SelectItem = React__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
  Item,
  {
    ref,
    className: cn(
...
const Select = React__default.forwardRef(({ onValueChange, defaultValue, placeholder, className, disabled, children, ...props }, ref) => {
  return /* @__PURE__ */ jsxs(Root2, { onValueChange, defaultValue, disabled, ...props, children: [
    /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(Value, { placeholder }) }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between w-full", children: /* @__PURE__ */ jsx("div", { className: "flex items-center pl-2 h-[32px]", children: /* @__PURE__ */ jsx("a", { href: landingPageUrl, children: /* @__PURE__ */ jsx(SvgComponent, { className: "h-[12px] w-[41px] object-contain" }) }) }) })
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "h-[32px] min-h-[32px]" })
  ] });
};
...
const Avatar = ({ name, photoUrl, initials }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-10 w-10 rounded-full bg-cowi flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-white", children: initials }) });
};
const UserInfo = React.forwardRef(
  ({ name, initials, email, photoUrl, profileUrl, onLogout }, ref) => {
    return /* @__PURE__ */ jsx("div", { ref, className: "relative inline-block", children: /* @__PURE__ */ jsxs(Root2$1, { children: [
      /* @__PURE__ */ jsx(Trigger$2, { asChild: true, children: /* @__PURE__ */ jsx(
        "button",
        {
          className: "flex items-center gap-2 rounded-full p-1 outline-none hover:bg-gray-100",
          "aria-label": "User menu",
          children: /* @__PURE__ */ jsx(Avatar, { name, initials, photoUrl })
        }
      ) }),
        ...
        Content2$1,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "px-3 py-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: email })
            ] }),
            /* @__PURE__ */ jsx(Item2, { asChild: true, children: /* @__PURE__ */ jsxs(
              "a",
              {
                href: profileUrl,
                className: cn(
